...
final class BombedMazeGame: DefaultMazeGame {
	override func makeRoom(number: Int) -> IRoom {
		return RoomWithABomb(roomNumber: number, haveBomb: number % 5 == 0)
	}

	override func makeWall() -> IWall {
		return BombedWall()
	}
}
